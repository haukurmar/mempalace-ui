...
export const EmptyState: FC<EmptyStateProps> = (props) => {
	...
	const renderedIcon = icon ?? <Inbox className="size-6" aria-hidden="true" />;
	...
	return (
		...
		>
			<div className="flex size-12 items-center justify-center rounded-full bg-secondary-100 text-secondary-700">
				{renderedIcon}
			</div>
